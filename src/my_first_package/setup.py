...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            "publisher_test = my_first_package.tests_publisher_subscriber.publisher_test:main",
            "subscriber_test = my_first_package.tests_publisher_subscriber.subscriber_test:main",
